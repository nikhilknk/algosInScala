...
public class MeetingScheduler {
    ...
    public static void main(String[] args) {
        ...
        Meeting[] meetingsToBook = new Meeting[]{
                //October 3rd 2014
                new Meeting(new Date(2016 - 1900, 10 - 1, 3, 15, 00), 15),
                new Meeting(new Date(2016- 1900, 10 - 1, 3, 16, 00), 15),
                new Meeting(new Date(2016 - 1900, 10 - 1, 3, 17, 00), 60),
                new Meeting(new Date(2016 - 1900, 10 - 1, 3, 18, 00), 15),
                new Meeting(new Date(2016 - 1900, 10 - 1, 3, 14, 50), 10),
                new Meeting(new Date(2016 - 1900, 10 - 1, 3, 14, 55), 10)
        };
