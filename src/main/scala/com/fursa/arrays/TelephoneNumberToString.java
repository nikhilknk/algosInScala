 ...
 *
 */
public class TelephoneNumberToString {

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		TreeSet<String> allPermutations = generatePermutations(new int[] { 8,
				2, 3, 4, 5, 6, 7 });
	...
	private static void getAllPermutation(int i, String s, Set<String> allPermutations,
			int[] telephoneNumber) {
